...
<div class="content-page">
    <h1 style="align:center">Home</h1>
     <!--this will display the first table in my database-->
    <div class="row1">
        <p>This first insert is an image of my database table that contains my image uploader table, it contains the ID which is Auto Incremented.<br>The Photo section which contains the names of the images which were uploaded.<br>Lastly the Username which contains the Usernames off the people who have posted images.</p>
        <img src="images/16572e8836b45c8071fbc2f400daa90f.png" style="width: 100%; height:130px">
    </div>
    <!--this will display the second tble of my databse.-->
    <div class="row1">
    	<p>This Second insert is an image of my database table that contains my message board table, it contains the ID which is Auto Incremented.<br>The Username section which contains the names of the people who have inserted a message.<br>Thirdly it contains the Date which is automatically added in real time.<br> Lastly it contains the message which the usage has posted.</p>
        <img src="images/9b9322f10bc040a8c5c4e6902725be23.png" style="width: 100%; height:100px">
    </div>
    <!--this section however will not display much, instead it will talk about the third section, it is rather confidential the third table so it can not be displayed.-->
    <div class="row1">
        <p>My last Database table contains personal information which is too confidental to show as an example, the Database table contains, the ID (Auto incremented)<br>
        Phone number<br>
        Gender<br>
        Email<br>
        Username<br>
        ...
        city<br>
        Profile Photo<br>
        and finally the Date that they joined, this is automatically updated.<br>
        Here is a screen shot of my databs table named RegFrom, <a href="https://gyazo.com/2ee6a0c45e84499261d2b358bd3c7db0">click here</a></p>
    </div>
</div>
